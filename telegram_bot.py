...
FUN = "Расскажи анекдот про Штирлица"
...
class ChatGPT3TelegramBot:
    ...
    async def help(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        await update.message.reply_text("/reset - Оновлює бесіду\n"
                                        "/fun - Розповідає анекдот про штирлица\n"
    ...
    async def fun(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        Показує анекдот.
        """
        await update.message.reply_text("Розказую анекдот про Штирлица:\n\n",
                                        disable_web_page_preview=True)
        ...
        response = self.openai.get_chat_response(chat_id=chat_id, query=FUN)
